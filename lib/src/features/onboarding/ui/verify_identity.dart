      ...
      child: Padding(
        ...
        child: Column(
          children:  [
            ...
            Center(child: Image.asset('assets/images/hand-document.png', height: h * 0.25, width: w * 0.5,)),
            ...
            SizedBox(height: h * 0.02,),
            const Text("Based on European legislation, BTC Direct is obliged to verify your identity. Complete your verification by uploading a valid ID card, driver's licence or passport.",
            ...
            InkWell(
              ...
              child: const Text("I don't have my ID with me ",
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,
          ...
          child: Column(
            ...
            children:  <Widget>[
              ...
              const Center(
                child: Text(
                  "No ID available",
                  style: TextStyle(color: AppColors.black, fontSize: 24, fontWeight: FontWeight.w600,fontFamily: 'TextaAlt',),
                ),
              ),
              Padding(

            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Image.asset('assets/images/email.png', height: h * 0.25, width: w * 0.5,),
                  ...
                  const Text('Email verification',
                   ...
                   SizedBox(height: h * 0.02,),
                  Text('Enter the 6-digit code you received on your email ${widget.email}.',
                  ...
                  RichText(
                    text: TextSpan(children: [
                      ...
                      TextSpan(
                        text: "Resend",
                        style: const TextStyle(color: AppColors.blueColor, fontSize: 16, fontWeight: FontWeight.w600,fontFamily: 'TextaAlt',),
                      ...
                      const TextSpan(text: "."),
                    ], style: const TextStyle(color: AppColors.greyColor, fontSize: 16, fontWeight: FontWeight.w500,fontFamily: 'TextaAlt',)),
                  ),
